...
const CompleteOrderView = ({ order, refetch }) => {
    const {
        TxID,
        card_issuer,
        carts,
    ...
    return (
        ...
        {/* Order Header */}
        <p className='absolute right-2 md:top-1 top-0 text-blue-500'><span className='block'>Delivered</span>{timeCoverterGMTtoLocal(deleveredAt)}</p>
        ...
        <div className="md:flex justify-between  mb-4">
          ...
          <div className="text-right">
            ...
            <p className="md:text-xl text-base text-[#ff3811]">Due: {due} BDT</p>
            <p className="md:text-2xl text-lg text-green-500">Revenue: {orderRevenue} BDT</p>
            <p className="md:text-2xl text-lg text-green-500">Profit: {orderProfit} BDT</p>
          </div>
        </div>
  
        {/* Order Management Controls */}
        <div className="flex justify-between items-center">
          <p className="text-green-500 text-xl px-7 py-2 border border-green-500 rounded-lg">
            {order_status}
          </p>
...
export default CompleteOrderView;